...
ULT_ICON_MAX_PROB = {GAMETYPE_OWL: 0.7, GAMETYPE_CUSTOM: 0.7}
ULT_ICON_MAX_PROB_SSIM = {GAMETYPE_OWL: 0.6, GAMETYPE_CUSTOM: 0.6}
ULT_ICON_MAX_BRIGHTNESS = {GAMETYPE_OWL: 230, GAMETYPE_CUSTOM: 220}
ULT_ICON_MAX_DEVIATION = {GAMETYPE_OWL: 15, GAMETYPE_CUSTOM: 15}
...
KILLFEED_MAX_COLOR_DISTANCE = {GAMETYPE_OWL: 120, GAMETYPE_CUSTOM: 20}
