...
SUPPORT_LIST = [ANA, BRIGITTE, LUCIO, MERCY, MOIRA, ZENYATTA]

DPS_LIST = [BASTION, DOOMFIST, GENJI, HANZO, JUNKRAT, MCCREE, MEI, PHARAH, REAPER, 
            SOLDIER76, SOMBRA, SYMMETRA, TORBJON, TRACER, WIDOWMAKER]

TANK_LIST = [DVA, ORISA, REINHARDT, ROADHOG, WINSTON, ZARYA, WRECKINGBALL]
