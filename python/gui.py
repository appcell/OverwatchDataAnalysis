...
class Gui(object):
    ...
    def __init__(self):
        ...
        self.read_btn = Button(
            self.read_frame, text="Choose file", command=self.click_read)
        ...
        self.save_btn = Button(
            self.save_frame, text="Choose file", command=self.click_save)
        ...
        self.right_team_name = Entry(
            self.right_frame, bg='lightBlue', fg='black')
