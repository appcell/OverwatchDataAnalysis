...
AVATAR_X_MIN_LEFT_OWL = 62
AVATAR_X_MIN_RIGHT_OWL = 857
AVATAR_WIDTH_OWL = 38
AVATAR_Y_MIN_OWL = 48
AVATAR_HEIGHT_OWL = 30
AVATAR_GAP_OWL = 71
...
def get_avatars_ref():
    return {chara: ImageUtils.resize(ImageUtils.read_with_transparency("../../images/charas/" + chara + ".png"), AVATAR_WIDTH, AVATAR_HEIGHT) \
